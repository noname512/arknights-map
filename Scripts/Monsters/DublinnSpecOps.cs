...
public class DublinnSpecOps : AbstractWildsMonster
{
    ...
    private int StrengthGain => AscensionHelper.GetValueIfAscension(AscensionLevel.DeadlyEnemies, 1, 1);
        ...
        MoveState attack1 = new MoveState(
            ...
            async targets =>
                await DamageCmd
                    ...
                    .WithHitFx(sfx: $"event:/ArknightsMap/sfx/{GetType().Name}/attack_fire")
                    .Execute(null),
