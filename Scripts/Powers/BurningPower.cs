...
public class BurningPower : ModPowerTemplate
{
    ...
    public override async Task AfterDeath(PlayerChoiceContext choiceContext, Creature creature, bool wasRemovalPrevented, float deathAnimLength)
    {
        ...
        await CreatureCmd.Damage(
            ...
            new DamageVar(Amount, ValueProp.Unpowered | ValueProp.SkipHurtAnim),
            c,
            null,
            null
        );
        await PowerCmd.Apply<FlamingDamagePower>(choiceContext, Owner.CombatState.PlayerCreatures, Amount, c, null);
    }
}
