...
public class CannonAndPriest : AbstractLateranoEncounter
{
    // 所有可能出现的怪物
    public override IEnumerable<MonsterModel> AllPossibleMonsters => [ModelDb.Monster<PathfinderCannon>(), ModelDb.Monster<SanktaPriest>()];
    ...
    protected override IReadOnlyList<(MonsterModel, string?)> GenerateMonsters() => [
        (ModelDb.Monster<PathfinderCannon>().ToMutable(), "first"), 
        (ModelDb.Monster<SanktaPriest>().ToMutable(), "second")
    ];
