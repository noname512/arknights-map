...
public class TwoMage : AbstractLateranoEncounter
{
    // 所有可能出现的怪物
    public override IEnumerable<MonsterModel> AllPossibleMonsters => 
    [ModelDb.Monster<PathfinderMage>()
    ];
...
public override IReadOnlyList<string> Slots => ["first", "second", "third"];
    ...
    protected override IReadOnlyList<(MonsterModel, string?)> GenerateMonsters() => [
        (ModelDb.Monster<PathfinderMage>().ToMutable(), "first"),
        (ModelDb.Monster<PathfinderMage>().ToMutable(), "second"),
