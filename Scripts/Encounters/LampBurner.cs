...
public class LampBurner : AbstractWildsEncounter
{
    public override IEnumerable<MonsterModel> AllPossibleMonsters => [ModelDb.Monster<BurningVine>(), ModelDb.Monster<CabbageSeedling>()];
    ...
    protected override IReadOnlyList<(MonsterModel, string?)> GenerateMonsters() => [(ModelDb.Monster<BurningVine>().ToMutable(), "second")];
}
