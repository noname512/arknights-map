...
public class HaroldCraigavonBoss : AbstractSnowyMountainEncounter
{
    public override IEnumerable<MonsterModel> AllPossibleMonsters => [ModelDb.Monster<HaroldCraigavon>()];
    ...
    public override IReadOnlyList<string> Slots => ["8"];
    ...
    protected override IReadOnlyList<(MonsterModel, string?)> GenerateMonsters() => [(ModelDb.Monster<HaroldCraigavon>().ToMutable(), "8")];
}
