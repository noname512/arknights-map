...
public class ComingFire : AbstractWildsEncounter
{
    ...
    // 所有可能出现的怪物
    public override IEnumerable<MonsterModel> AllPossibleMonsters => [ModelDb.Monster<DublinnFlamecaller>(), ModelDb.Monster<Fireball>()];
    ...
    protected override IReadOnlyList<(MonsterModel, string?)> GenerateMonsters() =>
        [(ModelDb.Monster<Fireball>().ToMutable(), "first"), (ModelDb.Monster<DublinnFlamecaller>().ToMutable(), "second")];
}
