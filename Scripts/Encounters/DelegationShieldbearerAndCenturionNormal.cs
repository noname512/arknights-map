...
public class DelegationShieldbearerAndCenturionNormal : AbstractSnowyMountainEncounter
{
    public override IEnumerable<MonsterModel> AllPossibleMonsters => [ModelDb.Monster<DelegationShieldbearer>(), ModelDb.Monster<DelegationCenturion>()];
    ...
    protected override IReadOnlyList<(MonsterModel, string?)> GenerateMonsters() =>
        [
            (ModelDb.Monster<DelegationShieldbearer>().ToMutable(), "5"), // 防折叠
            (ModelDb.Monster<DelegationCenturion>().ToMutable(), "7"),
        ];
}
