...
public class AddBulletIntent : AbstractIntent
{
    public override IntentType IntentType => IntentType.Unknown;
    protected override string IntentPrefix => "ARKNIGHTS_MAP_INTENT_ADD_BULLET";

    protected override string SpritePath => "res://ArknightsMap/images/util/AddBulletIntent.tres";
